...
| 計劃項目           | 進度     | 備註                           |
| ------------------ | -------- | ------------------------------ |
| 可靠度測試         | 進行中   | 張緊次數已達 965,000+，尚未發現故障 (截至 2024/12/23) [測試影片](https://youtube.com/shorts/LBGjt78jUYY) |
| 適用網球拍         | 測試中   | 在HW2.0 佈局上使用 GX80 滑台進行 75~85LB 循環張緊可靠度測試中。 張緊次數已達 615,000+ (截至 2024/12/23) |
| 3D列印結構         | 暫停測試   | HW3D Print 將採用 3D 列印方式，大幅降低機械加工難度，目前正在進行可靠性測試。 張緊次數已達 150,000+ (截至 2024/12/07)|
