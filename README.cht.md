...
> [!CAUTION]  
> **請務必使用 mpython 1.25.0 版本**
> 經測試發現，**mpython 1.26.0 及之後的版本**，步進馬達的運作速度約比 **1.25.0 版本慢 30%**。  
> 若您在 **INFO 介面** 中觀察到 **MR 值介於 1.10～1.25**，表示運作正常（mpython 1.25.0）。  
> 若 MR 值約為 **0.8x**，則代表您使用的是 **錯誤的 mpython 版本（1.26.0 或以上）**。
>
> **請參閱詳細說明與降版教學：** [MicroPython 1.25 說明](docs/2.Hardware_Setup.cht.md#micropython-125-%E7%89%88%E6%9C%AC%E8%A6%81%E6%B1%82)
...
| 計劃項目           | 進度     | 備註                           |
| ------------------ | -------- | ------------------------------ |
| PicoBETH-J            | 開發中 | PicoBETH 的平行開發版本，保留原有「便宜、簡單、精準」的核心理念，朝向更標準化、整合度更高且易於製作與維護的硬體設計發展。包含全新結構、PCB、配線與電源配置等設計。詳見：[PicoBETH-J 開發討論](https://github.com/206cc/PicoBETH/discussions/83) |
...
> [!NOTE]
> 對 **PicoBETH-J** 的開發過程有興趣，可以追蹤 Instagram [@picobeth_](https://www.instagram.com/picobeth_/)。PicoBETH-J 的開發紀錄、製作與測試進度將主要分享於此。
