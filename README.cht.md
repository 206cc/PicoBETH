...
本版本延續 SGX 1610 系列滑台，僅將 Load Cell 50kg 版本。由於 SGX 僅搭配一組 MGN12H 線性滑軌，因此建議最大張力不超過 70 lb，以確保滑台壽命。

> [!WARNING]
> 您還是可以使用 SGX 1605 滑台搭配 50 kg Load Cell 來達到 90 lb 的張力，但此作法會讓滑台長期承受更高負載，將大幅縮短滑台壽命（磨耗加劇、加速損壞）。
> 為了確保可靠度與耐用性，仍建議將 SGX 的最大張力控制在 70 lb 以下，若您的需求經常需要 70 lb 以上，建議改用 GX80 系列滑台，以避免過度消耗 SGX 滑台壽命。
