...
| ------------------------------------ | ----------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| PicoBETH-J                             | In Development | A parallel development version of PicoBETH that retains the original core principles of being economical, intuitive, and accurate, while moving toward a more standardized, highly integrated, and easier-to-build and maintain hardware design. It includes redesigned mechanical structures, PCBs, wiring, and power distribution. See: [PicoBETH-J Development Discussion](https://github.com/206cc/PicoBETH/discussions/83) |
| DM542 Series Stepper Motor Driver Testing | Completed | This test replaced the TB6600 with DM542, DM542C, and DM542S to evaluate noise reduction and assess their suitability for the project. See: [Hardware Setup, Procurement, and Maintenance](docs/2.Hardware_Setup.md#stepper-motor-drivers) |
...
> [!NOTE]
> If you are interested in the development of **PicoBETH-J**, follow Instagram [@picobeth_](https://www.instagram.com/picobeth_/). Development logs, build progress, and testing updates for PicoBETH-J will mainly be shared there.
