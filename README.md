...
- **High durability**
  - Over 395,000 tensioning reliability tests completed (testing ongoing)
...
| ------------------- | ---------- | -------------------------------------------- |
| Reliability Testing           | Ongoing   | Tensioning cycles have reached 395,000+ with no failures (as of 2024/10/07) [Test Video](https://youtube.com/shorts/0TDaBDEwqnI) |
| Tennis Racquet Compatibility   | Testing | Performing 75-85LB cyclic tension reliability testing using the GX80 sliding table. Tensioning cycles have reached 45,000+ (as of 2024/10/07) |
