...
| ------------------------------------ | ----------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Porting to Raspberry Pi Zero | In Progress | Replacing the original Raspberry Pi Pico with Raspberry Pi Zero and migrating the codebase. See the project page [https://github.com/206cc/ZeroBETH](https://github.com/206cc/ZeroBETH) for details. |
