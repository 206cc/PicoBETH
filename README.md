...
| ------------------------------------ | ----------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| New Stepper Driver Testing   | In Progress | Testing replacement of the TB6600 with DM542, DM542C, and DM542S to reduce noise and evaluate suitability for this project. |
| Porting to Raspberry Pi Zero | Paused | Replacing the original Raspberry Pi Pico with Raspberry Pi Zero and migrating the codebase. See the project page [https://github.com/206cc/ZeroBETH](https://github.com/206cc/ZeroBETH) for details. |
